...
const Recipes = [
    ...
    },
    {
        ...
        instructions: [
            ...
            'Mince garlic',
            'Fry up onions',
            'Add garlic once onions almost done',
    ...
    },
    {
        ...
        instructions: [
            ...
            'Once Warm add chopped onion and garlic',
            'Saute until the onion has softened and raw garlic smell is gone',
            'Roughly break sausages to small chunks ',
            'Add to the pan',
            'Saute for 5-6 minutes until they are browned and aromatic ',
            'Break any bigger chunk of sausage',
            'Deglaze the pot by adding stocks',
            'Scarp the bottom of the pan to remove any brown bits ',
            ...
            'Stir in between to prevent Orzo from getting stuck at the bottom',
    ...
    },
    {
        ...
        instructions: [
            ...
            'Spoon about 1/3 cup mixture in each leaf and roll up tight',
